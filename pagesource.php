...
// I don't know if I need this or not.
    ...
    //========================================================================
       ...
       /*    contextmenu: true, contextmenuWidth: 140, contextmenuItems: [{ 
        ...
        var uniqueCallList = ['W0DLK','WA0TJT',];        
         console.log('@414 allnameBounds = '+allnameBounds.toString());
            
         console.log('@416 '+uniqueCallList[0]+' '+uniqueCallList[1]+' lngth= '+uniqueCallList.length);
         ...
         //objectKoords= 39.202337,-94.602932,39.201986,-94.603036,39.20169,-94.603628,39.201259,-94.603175,39.201636,-94.602375,39.2025,-94.6025,39.20167,-94.60217,39.20117,-94.60167,39.20067,-94.6015,39.201016,-94.601541,39.201393,-94.601576,39.203,-94.60233,39.203,-94.60233,39.203,-94.60233;
       ...
       var u = -1; // to iterate through the colorwheel
        ...
        u++;
            ...
            newcolor = colorwheel[u]; // sets the color in the var objectLine below
                console.log('@433 z= '+u+', newcolor= '+newcolor+', cw= '+colorwheel[u]);
            
            // Add connecting lines between the object markers           
            const objectKoords = connectTheDots(OBJMarkerList);   
                console.log('@437 objectKoords= '+objectKoords);
            const objectLine = L.polyline(objectKoords,{color: newcolor, weight: 4}).addTo(map);
        
            // Add connecting lines between the corners of the objects
           //var KornerList = L.layerGroup([W0DLKob1, W0DLKob2, W0DLKob3, W0DLKob4, W0DLKob6,WA0TJTob1, WA0TJTob2, WA0TJTob3, WA0TJTob4, WA0TJTob6,]);           //objectKornerKoords = connectTheDots(KornerList);
           //var objectKornerLine = L.polyline(objectKornerKoords,{color: newcolor, weight: 5}).addTo(map);    
           
                console.log('@445 z= '+z+', newcolor= '+newcolor+', cw= '+colorwheel[u]);
