 ...
 var dothework = $(".closenet").html().trim(); //alert(dothework);  
   ...
   if ( dothework == "Close Net") {
	 	...
	 	$(".editable_selectMode").editable("save.php", {	// Mode 
             data    : '{"":"","Voice":"Voice","CW":"CW","Mob":"Mob","HT":"HT","Dig":"Dig","FSQ":"FSQ","D*":"D*","Echo":"Echo","DMR":"DMR","Pi-Star":"Pi-Star","Fusion":"Fusion","Winlink":"Winlink","V&D":"V&D","Online":"Online","Relay":"Relay"}',
    	     type: "select",  
    	     placeholder: "",
    	     onblur: "submit",
    	     submit:"OK",
