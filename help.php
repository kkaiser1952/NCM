...
<div class="twocolrow" style="margin:0; width: 100%;">
  <div class="twocolumn" style="width: 50%;">
	...
	<b style="color:blue;"><abbr title="Net Control Station">NCS</b></abbr> - Net Control Station<br>
...
<!--	<b style="color:black;">CERT</b> - Community Emergency Response Team<br> -->
	...
	<b style="color:#aa7941;">MARS</b> - Military Auxiliary Radio system
  </div>
</div>
...
<div class="helpfulhints">
    <a id="helpfulhints"></a>
		...
		<p>Before starting a new net, be sure someone hasn't already started it. Check the dropdown for a green (open) net.</p>
...
<div class="homepage">
	...
	<div class="TZdescription" style="float: left;">
	 <p>
		This is the first page you see when opening Net Control Manager.
		<br><br>The version number here is 5.10.21 representing the fifth year of NCM the 10th month, modified on the 21st.
	</p>
...
<div class="homepage">
	...
	<div style="padding-left: 20px;">
	 <p>
		A closed net open for viewing. Notice the extra columns like; tactical, credentials and tt#.
		<br><br>Notice the "Refresh", "Time" and "'NetClosed" buttons, the MODES ==> ... Closed under the button bar and that all Time Out values are present.
		<br><br>The Local timezone is selected and the upper right corner is populated with net information.
	</p>
...
<div style="padding-left: 20px;">
 <p>
	Before clicking the <b style="color:red">'Start A New Net'</b> button check to see that someone else has not already started the net for you. To do this, 
		...
		<p>A net with a green background (second one in this example) is an open net (is still in use).</p>
...
<img style="float:left; padding-right: 10px; border-radius: 10px;" src="screenshots/startnewnetTest.png" alt="startnewnet" width="341" height="615" />
 ...
 <p>
	Before clicking the <b style="color:red">'Start A New Net'</b> button check to see that someone else has not already started the net for you. To do this, 
	   ...
	   <p>Enter your call sign in the top most box, this is your personal call sign, issued by the FCC NOT the club call sign.</p>
       ...
       <hr>
    	<p>The second example here shows you what happens if you click the 'Click to buikd a TE0ST net' button. It fills all the dropdown boxes for you. However you may change any of these you wish, even the Group or Call. 
    	</p>
    	
    	<p>Click on <b style="color:red">Submit</b>.</p>
	
	   <p>At this point a new net grid should be displayed, listing you as having opened it.</p>
	</div>
</div>
...
<h3>DELETE AN ENTRY</h3>
	...
	<p>
		To delete an entry, locate the small <b style="color:red">red x</b> at the end of the row. Click on it, or on the words (Click to delete). <br>A dialog box will open asking you to confirm. 
			Choose your option.<br> Another method if the above doesn't work is to type in the 'Tactical' column 'DELETE' in all caps. Be sure its the only thing in the cell and not adding to a tactical call. You'll know if this worked because <span class="firstword">N</span><span class="secondword">C</span><span class="thirdword">M</span> will respond with a "DELETED successfully", the row will be deleted on the next refresh.<br>A delete is not undoable, if needed just add the call again.
	</p>
	<p>
...
<h4>Role has the following dropdown options</h4>
	...
	<p><b>blank</b> - This is the default indicating no specific role for this station</p>
   	<p><b>PRM</b> - This designates the primary net control operator</p>
   	<p><b>2nd</b> - The backup net control operator</p>
   	
   	<p><b>LSN</b> - Liaison to anther group/net/facility etc. You might want to use the TACTICAL column to indicate who the liaison is for. (i.e. SEMA)</p>
   	<p><b>Log</b> - The person keeping the Log if not the PRM </p>
   	<p><b>EM</b>  - Emergency Manager</p>
   	<p><b>PIO</b> - Public Information Officer</p>
...
<div class="flexcontainer">
	<div style="width: 50%;">
		...
		<h4>Traffic Indicates the station has traffic, and what kind</h4>
		  <ul style="list-style-type:none;">
			<li><b>blank is the default for no traffic</b></li>
			<li><b>Routine</b></li>
			<li><b>Welfare</b></li>
			<li><b>Priority</b></li>
...
<p>Band this station has checked in from.
	<br><br>
</p>
</div>
...
<img style="float:right; padding-left: 10px; border-radius: 10px;" src="screenshots/tactical.png" alt="tactical" width="430" height="274" />
...
<p>what3words is an easy way to talk about any precise location in the world. It gives every 3m x 3m square a unique combination of three words: a what3words address.
...
<p>Adding or changing this field also changes the latitude, longitude and grid columns. Additionally the nearest cross roads will be added to the W3W column and documented in the Time Log.</p>
             ...
             <p>See <a href="https://what3words.com" target="_blank">https://what3words.com</a> for more information.</p>
</div> <!-- End what3words -->
...
<p>The APRStt system using the Direwolf TNC by WB2OSZ, and based on work by WB4ABR will be more fully discussed here... soon.</p>
