<?php
   ...
   $sql = (" SELECT callsign, 
        ...
        //  echo "$sql<br><br>";
          ...
          $OBJMarkerList = "";
          $listofMarkers = "";
          $ObjectList = "var ObjectsList = L.layerGroup([";
    ...
    $sql = (" SELECT MIN(x(latlng))  as minLat,
       ...
       foreach($db_found->query($sql) as $objCorners) {
    	   $minLat = $objCorners[minLat]-0.05;
    	   $maxLat = $objCorners[maxLat]+0.05;
    	   $minLng = $objCorners[minLng]+0.05;
    	   $maxLng = $objCorners[maxLng]-0.05;
    	   
    	   $Objpoly = " $maxLat $maxLng  , $maxLat $minLng  , $minLat $minLng  , $minLat $maxLng  , $maxLat $maxLng  ";
	   };	  
       ...
       $cntObjPoints = "[[$maxLat, $maxLng], [$maxLat, $minLng ], [$minLat, $minLng ], [$minLat, $maxLng ], [$maxLat, $maxLng]]";
       
      // echo "objPoly= $Objpoly <br>";
      // echo "cntobjPoints= $cntObjPoints <br>";
    ...
    // replace last comma with closed square bracket, or a comma or whatever....       
        $objBounds  = substr($objBounds, 0, -1)."";               //echo ("objBounds= <br>$objBounds<br><br>");       
