...
SELECT  fcc.fccid
  ...
  WHERE log.netId  $netID 
    ...
    ORDER BY log.netID, log.callsign, log.recordID
");


$fixrequests = "<h2>Changes to the following records for net # ".$netID." were made to the stations Table:</h2><br>";
$query = '';
$address = '';
foreach($db_found->query($sql) as $row) {
    ...
    $query = "UPDATE stations SET  
                    ...
                    district  = (SELECT district FROM HPD WHERE state = '$row[state]' AND county = '$county')
