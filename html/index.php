...
<span id="version">
    ...
    <p class="tb1 TipBubbles initiallyHidden" style="left: 100px; width: 400px;  margin-bottom: 30px;">
	...
	<button onclick="topFunction()" id="myBtn" title="Go to top">Top</button>
     ...
     <!-- All the quotes go here -->
    	...
    	<h2 class="quotes">
        	...
        	<img src="images/ARES.png" alt="ARES" width="100" height="" >
        	<img src="images/RACES.png" alt="RACES" width="100" height="" >
        	 <img src="images/satern.png" alt="satern" width="100" height="" >
        	
        	<img src="images/waefar.png" alt="waefar" width="225" height="" >
        	<br>
        	<img src="images/redcross.png" alt="redcross" width="225" height="" >
        	 
        	 <img src="images/mars.png" alt="mars" width="100" height="" >      	 
        	 
        	 <img src="images/skywarn.png" alt="skywarn" width="100" height="" >
        	 <img src="images/nts.png" alt="nts" width="100" height="" >
        ...
        <h2 class="quotes">NCM is not a replacement for pen and paper, which will always be your 
            best backup should something go wrong.
        </h2>
        <h2 class="quotes">NCM was designed to be easily usable by the Net Control Operator (NCO) 
            alone, however someone else keeping log while you control the net is always a good idea.
        </h2>
...
(function() {
 ...
            .delay(200) //time until fade out
            .fadeOut(5700, showNextQuote); //fade out time, recall function
    }
    showNextQuote();  
})();
